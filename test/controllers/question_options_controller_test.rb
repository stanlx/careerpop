...
class QuestionOptionsControllerTest < ActionController::TestCase
  ...
  test "should create question_option" do
    assert_difference('QuestionOption.count') do
      post :create, question_option: { option_choice_id: @question_option.option_choice_id, question_id: @question_option.question_id }
    end
  ...
  test "should update question_option" do
    patch :update, id: @question_option, question_option: { option_choice_id: @question_option.option_choice_id, question_id: @question_option.question_id }
    assert_redirected_to question_option_path(assigns(:question_option))
  end
